...
| <hr>                              | <i class="fa-brands fa-tailwind-css"></i> Tailwind                  | <i class="fa-brands fa-bootstrap"></i> Bootstrap | Pico ✨                                 | 🥷 [*Bl*ades](/css/)                              | <small>Example 1:</small><br> [Pico+*Bl*ades](https://blades.ninja/css/pico/) | <small>Example 2:</small><br> [Tailwind+*Bl*ades](https://build.blades.ninja/) |
| --------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------ | --------------------------------------- | ------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
